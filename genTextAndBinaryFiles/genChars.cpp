...
int main(int argc, char** argv) {
    ...
    outFile.close();
    cout << '\n' << data.size() << " random chars from range " 
	 << LOW << " to " << HIGH 
         << "\n written to '" 
